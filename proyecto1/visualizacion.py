...
def graficar_recoleccion_vs_bateria(resultados: dict):
    """
    Genera un gráfico de barras agrupadas comparando la basura recolectada
    vs el consumo de batería por cada robot.

    Parámetro:
        resultados: diccionario con nombre del robot como clave y métricas como valor.
    """

    # 1. Extraer nombres de los robots (categorías del eje X)
